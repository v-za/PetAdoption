...
def adoptionAdd():
    ...
    if form.validate_on_submit() and form.submit.data:
        if form.picture.data:
            ...
            request = PetRequest(petName=form.name.data,petType=form.type.data,petGender = form.gender.data, petBreed=form.breed.data,petAge=form.age.data,petDesc=form.description.data,petContactName=current_user.name,petContactEmail=current_user.email,petContactPhone=current_user.phone,petImage=picture_file)
        else:
            request = PetRequest(petName=form.name.data,petType=form.type.data,petGender = form.gender.data, petBreed=form.breed.data,petAge=form.age.data,petDesc=form.description.data,petContactName=current_user.name,petContactEmail=current_user.email,petContactPhone=current_user.phone)
